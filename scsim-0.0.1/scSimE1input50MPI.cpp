 ...
 )
{
  ...
  PopGrowth(npop,tps,tgen,kgen,1,0,popn,tree,myrang.int64());


  PopGrowth(npop,tps,tgen,2*kgen,0.5,0,popn,tree,myrang.int64());
  ...
  PopGrowth(npop,tps,tgen,2,br2,br2-0.1,popn,tree,myrang.int64());
  PopGrowth(npop,tps,tgen,20,br2+0.1,br2-0.1,popn,tree,myrang.int64());
  tps+=npop;
